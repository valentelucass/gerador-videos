...
def boost_output_volume(wav: np.ndarray) -> np.ndarray:
    """Raise low generated speech to a practical playback level without clipping."""
    if wav is None:
        return wav
...
class VoxCPMDemo:
    ...
    def generate_tts_audio(
        ...
        wav = boost_output_volume(current_model.generate(**generate_kwargs))
