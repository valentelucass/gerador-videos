...
try:
    from backend.src.config.settings import BACKGROUND_MUSIC_DIR, OUTPUT_DIR, TEMP_DIR, TRANSITIONS_DIR
    from backend.src.core.editor_ffmpeg import FFmpegEngine
    from backend.src.core.legendas_ass import GeradorLegendasASS
    from backend.src.core.pexels_fetcher import PexelsFetcher, PexelsFetcherError
    from backend.src.core.tts_clonador import TTSManager
    from backend.src.core.whisper_sync import WhisperSync
    from backend.src.utils.logger import get_logger
    from backend.src.utils.run_reporter import RunReporter
    from backend.src.utils.text_helpers import normalizar_ascii
    from backend.src.utils.workspace_cleaner import WorkspaceCleaner
