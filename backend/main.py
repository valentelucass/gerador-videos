...
# Permite tanto ``python -m backend.main`` quanto ``python backend/main.py``.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--limpar",
        action="store_true",
        help="Remove lotes, previews e temporarios; preserva todos os MP4s finais em workspace/output.",
    )
